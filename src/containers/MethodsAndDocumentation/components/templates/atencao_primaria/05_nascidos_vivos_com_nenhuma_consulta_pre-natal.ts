...
export const nascidosVivosComNenhumaConsultaPreNatal = {
  pageTitle: 'Nascidos Vivos com Nenhuma Consulta Pré-Natal (%)',
  indicadorTitle: 'Indicador',
  indicadorContent:
    'Percentual de nascidos vivos cujas mães não tiveram nenhum acompanhamento pré-natal.',
  interpretacaoTitle: 'Interpretação',
  interpretacaoContent:
    'Estima a cobertura do atendimento pré-natal de gestantes por localidade geográfica e período. Logo, quanto menor a proporção de nascidos vivos com zero consultas pré-natal, maior o acesso e a qualidade do serviço de exame pré-natal para a população.',
  usosTitle: 'Usos',
  usosContent:
  ...
  formulaContent: [
    ...
    {
      item: 'Foi gerada uma variável referente àqueles que não realizaram nenhuma consulta (classificados sob “1”).',
      explain: [],
    },
    {
