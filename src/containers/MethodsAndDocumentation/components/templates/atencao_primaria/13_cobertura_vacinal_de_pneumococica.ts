export const coberturaVacinalDePneumococica = {
  pageTitle: 'Cobertura Vacinal de Pneumocócica (%)',
  indicadorTitle: 'Indicador',
  indicadorContent:
    'Cobertura vacinal estimada de Pneumocócica, considerando a população-alvo. <br><br>A vacina Pneumocócica 10-valente Conjugada (VPC-10) protege crianças contra doenças causadas pela bactéria Streptococcus pneumoniae, dentre as quais destacam-se a meningite, a pneumonia, a otite  média aguda, a sinusite e a bacteremia. O seu esquema de vacinação envolve duas doses aos 2 e 4 meses, seguidas de um reforço aos 12 meses¹.',
  ...
  populacaoContent: 'Crianças de até 5 anos.',
