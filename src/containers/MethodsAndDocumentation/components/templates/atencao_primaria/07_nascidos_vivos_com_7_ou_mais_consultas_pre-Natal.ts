...
export const nascidosVivosCom7ouMaisConsultasPreNatal = {
  pageTitle: 'Nascidos Vivos com 7 ou Mais Consultas Pré-Natal (%)',
  indicadorTitle: 'Indicador',
  indicadorContent:
    'Percentual de nascidos vivos cujas mães tiveram sete ou mais consultas pré-natal.',
  interpretacaoTitle: 'Interpretação',
  interpretacaoContent:
    'Estima a cobertura do atendimento pré-natal de gestantes por localidade geográfica e período. Quanto maior a proporção de nascidos vivos com sete ou mais consultas pré-natal, maior o acesso e a qualidade do serviço de exame pré-natal para a população.',
  usosTitle: 'Usos',
  usosContent:
  ...
  formulaContent: [
    ...
    {
      item: 'Foi gerada uma variável referente àqueles que realizaram sete ou mais consultas (classificados sob “4”).',
      explain: [],
    },
    {
