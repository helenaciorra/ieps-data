...
export const PerDaPopulacaoCom514anos = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          % da População com 5-14 anos
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Percentual da população entre 5 e 14 anos de idade.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Apresenta o percentual da população que possui entre 5 e 14 anos, englobando portanto parte considerável da 
          infância até a entrada no contingente de população em idade apta a trabalhar (entre 15 e 64 anos).
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais do percentual da população com idades 
          entre 5 e 14 anos, tal como levantado pela RIPSA¹.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            Foi realizado o cálculo do percentual da população entre 5 e 14 anos conforme a seguinte fórmula:
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ⁴ Oliveira LAP de, Simões CC da S. O IBGE e as pesquisas populacionais. Rev Bras Estud 
              Popul. 2005;22(2):291–302.{' '}
              <a
