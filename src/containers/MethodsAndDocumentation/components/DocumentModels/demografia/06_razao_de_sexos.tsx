  ...
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de homens para cada grupo de 100 mulheres na população residente.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Expressa a relação quantitativa entre os sexos. Quando o valor do indicador é igual a 100 significa que o 
          número de homens e mulheres é o mesmo. Este indicador é influenciado por taxas de migração e mortalidade 
          diferenciadas por sexo, conforme indicado pela RIPSA¹.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais na distribuição da população por sexo, tal 
          como apontado pela RIPSA¹, além de ajudar na identificação de áreas de atenção para estudos de gênero.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Subnotificação de óbitos e nascimentos'}>
        ...
        <S.Paragraphy>
          ...
          de informações do Registro Civil. No caso das estimativas populacionais realizadas pelo TabNet/DATASUS, 
          as estatísticas oficiais de população divulgadas pelo IBGE e utilizadas para convergência fazem uso de dados 
          de Registro Civil⁴. 
        </S.Paragraphy>
        <S.Paragraphy>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            Foi realizado o cálculo da razão entre sexos conforme a seguinte fórmula:
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ Brasil, Ministério da Saúde. Rede Interagencial de Informações para Saúde (RIPSA). Razão de sexos - 
              A.2 - 2012.[Internet] [citado 15 de outubro de 2021]. Disponível em:{' '}
              <a
                href="https://fichas.ripsa.org.br/2012/a-2/?l=pt_BR."
                target="_blank"
                rel="noreferrer"
                style={{ color: `${textColor}`, textDecoration: 'none' }}
              >
                https://fichas.ripsa.org.br/2012/a-2/?l=pt_BR.
              </a>
            </S.ReferenciaLink>
            <S.ReferenciaLink>
