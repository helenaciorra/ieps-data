...
export const PerDaPopulacaoEmIdadeAtiva1564 = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          % da População em Idade Ativa (15-64 anos)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Percentual da população em idade ativa (entre 15 e 64 anos de idade).
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Apresenta o percentual da população que se encontra em idade ativa, sendo esta faixa etária 
          definida como entre 15 e 64 anos¹.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais do percentual da população em idade ativa, 
          além de ajudar a identificar tendências no mercado de trabalho local.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Subnotificação de óbitos e nascimentos'}>
        ...
        <S.Paragraphy>
          Outra importante fonte de informação acerca de eventos vitais são os Sistemas de Informação no âmbito 
          do Ministério da Saúde (SIM e SINASC). Um dos objetivos de criação destas bases de dados seria justamente 
          cobrir lacunas deixadas pelo Registro Civil⁶. Ocorreu, entretanto, que essas novas fontes apresentaram as 
          mesmas limitações referentes à subnotificação que os dados do Registro Civil, ainda que o problema venha sendo 
      ...
      <Section title={'Migrações'}>
        <S.Paragraphy>
          ...
          Amostra de Domicílios Contínua (PNAD Contínua) fossem animadoras, a não realização do Censo demográfico 
          em 2020 fragiliza a estimação desse componente com maior precisão.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            Utilizou-se a metodologia para estimativas anuais de população municipal por idade e sexo conforme 
            publicado em Nota Técnica do TabNet/DATASUS², que incorpora três premissas básicas:
            <S.Ul>
              <S.Li>
          ...
          <S.Li>
            Foi realizado o cálculo do percentual da população entre 15 e 64 anos conforme a seguinte fórmula:
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ Alves JED. A transição demográfica e a janela de oportunidade. São Paulo: Instituto Fernand Braudel de 
              Economia Mundial, p. 3, 2008{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
