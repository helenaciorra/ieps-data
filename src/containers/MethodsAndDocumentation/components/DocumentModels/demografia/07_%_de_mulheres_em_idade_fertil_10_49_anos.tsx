...
export const PerDeMulheresEmIdadeFertil1049Anos = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          % de Mulheres em Idade Fértil (10-49 anos)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Percentual de mulheres em idade fértil (entre 10 e 49 anos de idade).
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Apresenta o percentual de mulheres que se encontram em idade fértil, definida como entre 10 a 49 anos¹.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais da oferta da quantidade de leitos (nesse 
          caso, leitos UTI não-SUS), conforme consta na documentação da RIPSA¹, identificando situações de desigualdade 
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          de 2010. Além disso, há a subnotificação de óbitos e nascimentos, especialmente em áreas menos desenvolvidas e 
          pequenos municípios³. Municípios de pequeno porte estão mais sujeitos a erros em decorrência do impacto por 
          variações nos componentes demográficos (fecundidade, mortalidade e migração) e devem ser utilizados com 
          cautela. Ademais, destaca-se que dois dos maiores desafios no cálculo de estimativas populacionais dizem 
          respeito à subnotificação de dados de nascimento e mortalidade e a migrações.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Subnotificação de óbitos e nascimentos'}>
        ...
        <S.Paragraphy>
          Atualmente, após 
          parceria firmada entre o IBGE e o Ministério da Saúde, o pareamento das duas bases de dados tem sido realizado 
          tendo em vista o objetivo futuro de integração entre os sistemas⁴.
        </S.Paragraphy>
      </Section>
        ...
        <S.Ol>
          <S.Li>
            ...
            <S.Ul>
              ...
              <S.Li>
                Compatibilização Metodológica, em que garante-se que as estimativas geradas sejam estatisticamente 
                compatíveis ao longo do tempo.
              </S.Li>
            </S.Ul>
          </S.Li>
          <S.Li>
            Foi realizado o cálculo do percentual de mulheres em idade fértil conforme a seguinte fórmula:
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              {`¹ Brasil, Ministério da Saúde. Óbitos de mulheres em idade fértil e óbitos maternos - Brasil [Internet]. 
              [citado 15 de outubro de 2021. Disponível em Brasil, Ministério da Saúde. Número de leitos hospitalares por 
              habitante – CNES/MS – E.3 [Internet].[citado 14 de outubro de 2021]. Disponível em:`}{' '}
              <a
                href="https://tabnet.datasus.gov.br/cgi/deftohtm.exe?sim/cnv/mat10uf.def"
                target="_blank"
                rel="noreferrer"
                style={{ color: `${textColor}`, textDecoration: 'none' }}
              >
                https://tabnet.datasus.gov.br/cgi/deftohtm.exe?sim/cnv/mat10uf.def
              </a>
            </S.ReferenciaLink>
            <S.ReferenciaLink>
