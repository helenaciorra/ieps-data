...
export const PerDaPopulacaoCom65Anos = () => {
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Percentual da população com 65 ou mais anos de idade.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Aponta a participação relativa de idosos na população geral, bem como o ritmo de envelhecimento da população, 
          conforme especificado pela RIPSA¹. O crescimento da população de idosos está associado à redução das taxas 
          de fecundidade e de natalidade e ao aumento da esperança de vida.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite avaliar variações geográficas e temporais na distribuição de idosos, tal como levantado 
          pela RIPSA¹. Além disso, pode contribuir para a elaboração de políticas públicas voltadas à saúde, 
          previdência e assistência social a idosos.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          TabNet/DATASUS². Deve-se também considerar a não realização do Censo 2020, sendo o último levantamento 
          datado de 2010. Além disso, há a subnotificação de óbitos e nascimentos, especialmente em áreas menos 
          desenvolvidas e pequenos municípios³. Municípios de pequeno porte estão mais sujeitos a erros em decorrência 
          do impacto por variações nos componentes demográficos (fecundidade, mortalidade e migração) e devem ser 
          utilizados com cautela. Ademais, destaca-se que dois dos maiores desafios no cálculo de estimativas 
          populacionais dizem respeito à subnotificação de dados de nascimento e mortalidade e a migrações.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Subnotificação de óbitos e nascimentos'}>
        <S.Paragraphy>
          ...
          de nascimentos e de óbitos. Estas estimativas são atualmente realizadas utilizando-se como base estatísticas 
          do Registro Civil e estatísticas do Ministério da Saúde (provenientes do Sistema de Informações sobre 
        ...
        <S.Paragraphy>
          ...
          estatísticas oficiais de população divulgadas pelo IBGE e utilizadas para convergência fazem uso de dados 
          de Registro Civil⁴. 
        </S.Paragraphy>
        <S.Paragraphy>
          Outra importante fonte de informação acerca de eventos vitais são os Sistemas de Informação no âmbito do 
          Ministério da Saúde (SIM e SINASC). Um dos objetivos de criação destas bases de dados 
          seria justamente cobrir lacunas deixadas pelo Registro Civil⁶. Ocorreu, entretanto, que essas novas fontes 
          apresentaram as mesmas limitações referentes à subnotificação que os dados do Registro Civil, ainda que o 
          problema venha sendo superado e a cobertura de informações se torne cada vez mais completa. Para o ano de 2015, 
          estimativas apontam que o indicador de cobertura do SIM para o Brasil foi de 97,2% (mínimo de 91,2% no Amapá). 
          Em relação ao SINASC, a cobertura estimada foi de 97,7% para o Brasil (mínimo de 93,6% em Roraima)⁴. 
        </S.Paragraphy>
        <S.Paragraphy>
      ...
      <Section title={'Migrações'}>
        <S.Paragraphy>
          ...
          época a respeito do estudo de fenômenos migratórios utilizando dados do Censo e da Pesquisa Nacional por 
          Amostra de Domicílios Contínua (PNAD Contínua) fossem animadoras, a não realização do Censo demográfico em 
          2020 fragiliza a estimação desse componente com maior precisão.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            Foi realizado o cálculo do percentual da população com 65 anos ou mais conforme a seguinte fórmula:
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ Brasil, Ministério da Saúde. Rede Interagencial de Informações para Saúde (RIPSA).Proporção de idosos 
              na população - A.14 - 2012.[Internet] [citado 15 de outubro de 2021]. Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ⁴ de Oliveira, Antônio Tadeu Ribeiro. Sistemas de estatísticas vitais no Brasil : avanços, perspectivas 
              e desafios. IBGE, Coordenação de População e Indicadores Sociais. 2018; ISBN:978-85-240-4459-5.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
              ⁵ Oliveira LAP de, Simões CC da S. O IBGE e as pesquisas populacionais. Rev Bras Estud Popul. 
              2005;22(2):291–302{' '}
              <a
