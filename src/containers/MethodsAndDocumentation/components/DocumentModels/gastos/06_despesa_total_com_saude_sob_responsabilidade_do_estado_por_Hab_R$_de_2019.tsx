...
export const DespesaTotalComSaudeSobResponsabilidadeDoEstadoPorHabDe2019 = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Despesa Total com Saúde Sob Responsabilidade do Estado (por Hab., R$ de 2021)
        </S.PageTitle>
      </div>
      ...
      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Representa a despesa total com Saúde, inclusive aquela financiada por outras esferas de governo, por 
          habitante. Conforme Nota Técnica do Ministério da Saúde¹, este indicador resulta do gasto em saúde, por 
          habitante, advindo de todas as fontes, quer sejam impostos, transferências do SUS, operações de créditos 
          e outras.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          saúde por habitante, conforme levantado pela RIPSA², bem como subsidiar processos de planejamento, 
          gestão e avaliação de políticas públicas de saúde.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ² RIPSA. Ficha de qualificação: gastos com ações e serviços públicos de saúde per capita [Internet]. 
              [Citado 25 de outubro de 2021]. Disponível em:{' '}
              <a
                href="https://fichas.ripsa.org.br/2012/e-6-2/?l=pt_BR."
                target="_blank"
                rel="noreferrer"
                style={{ color: `${textColor}`, textDecoration: 'none' }}
              >
                https://fichas.ripsa.org.br/2012/e-6-2/?l=pt_BR.
              </a>
            </S.ReferenciaLink>
            <S.ReferenciaLink>
            ...
            <S.ReferenciaLink>
              ⁶ Piola, Sérgio F., et al. Financiamento público da saúde: uma história à procura de rumo. No. 1846. Texto para discussão, 2013.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
              ⁷ CONASS. Guia de Apoio à Gestão Estadual do SUS. Gestão Financeira [Internet]. [citado 25 de outubro de 2021]. Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ⁸ Brasil. Decreto n° 7.827, de 16 de outubro de 2012 [Internet]. [citado 25 de outubro de 2021]. Disponível em: {' '}
              <a
                href="https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2012/decreto/d7827.htm."
                target="_blank"
                rel="noreferrer"
                style={{ color: `${textColor}`, textDecoration: 'none' }}
              >
            ...
            <S.ReferenciaLink>
              ¹² VIEIRA, F. S. et al. Controvérsias sobre o Novo Regime Fiscal e a apuração do gasto mínimo constitucional com saúde. Ipea, 2018.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
