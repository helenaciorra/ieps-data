...
import formulaImage2 from './img/04_02.png';
import { textColor } from '../../../../../constants/theme';

export const ParticipacaoDaReceitaPropriaEstadualAplicadaEmSaudeEC29 = () => {
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Participação (%) da receita própria dos estados aplicada em ações e serviços públicos de saúde conforme a Emenda Constitucional n. 29 de 20001.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Representa o percentual de recursos próprios aplicados em saúde, conforme previsto na Emenda Constitucional n. 29/2000¹. 
          Cabe esclarecer que, segundo Nota Técnica do Ministério da Saúde², recursos próprios são os impostos arrecadados 
          diretamente pelo estado e os transferidos pelas outras esferas de governo, mediante definição constitucional. 
          Ações e serviços públicos em saúde (ASPS) foram inicialmente definidos na Resolução n. 322 do Conselho Nacional 
          de Saúde³, de 8 de maio de 2003. Em 2012, essas definições foram estabelecidas em Lei, através da Lei Complementar n. 141⁴.
        </S.Paragraphy>
      </Section>

      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador fornece uma medida do cumprimento da EC n. 29/2000 por parte dos entes federativos com base nos 
          parâmetros definidos na Resolução n. 322/2003, do Conselho Nacional de Saúde/CNS.
        </S.Paragraphy>
      </Section>
