...
import formulaImage2 from './img/05_02.png';
import { textColor } from '../../../../../constants/theme';

export const DespesaEmSaudeUtilizandoRecursosPropriosDoEstadoPorHabDe2019 = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Despesa em Saúde Utilizando Recursos Próprios do Estado (por Hab., R$ de 2021)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Despesa com ações e serviços públicos de saúde (ASPS) utilizando recursos próprios do estado, por habitante.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Representa o valor per capita das despesas em ASPS com recursos próprios. Logo, quanto maior o valor, maior 
          o dispêndio público com saúde por habitante. Cabe esclarecer que, segundo Nota Técnica do Ministério da Saúde¹, 
          recursos próprios são os impostos arrecadados diretamente pelo estado e os transferidos pelas outras esferas 
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          ...
          do Sistema de Informações sobre Orçamento Público em Saúde (SIOPS). Eventuais falhas exigem cautela na interpretação. 
          Além disso, os dados de população disponíveis na base do TabNet do SIOPS não são os mesmos disponibilizados pelo 
          próprio TabNet. Os valores disponibilizados pelo TabNet consistem na despesa empenhada, quando a fase mais 
          indicada para retratar a aplicação de recursos é a despesa liquidada.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Link">
        <S.Link
          target="_blank"
          href="https://siops-asp.datasus.gov.br/cgi/tabcgi.exe?SIOPS/SerHist/ESTADO/indicuf.def"
        >
          https://siops-asp.datasus.gov.br/cgi/tabcgi.exe?SIOPS/SerHist/ESTADO/indicuf.def
        </S.Link>
        <br/>
        <S.Link
          target="_blank"
        ...
        <S.Ol>
          <S.Li>
            ...
            <S.Ul>
              ...
              <S.Li>Receitas Próprias: são os impostos arrecadados diretamente pelo estado e os transferidos pelas outras esferas de governo, mediante definição constitucional.</S.Li>
            </S.Ul>
          </S.Li>
