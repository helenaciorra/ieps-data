...
export const LeitosUtiNaoSus = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Leitos UTI Não-SUS (por 100.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de leitos de Unidades de Terapia Intensiva (UTI) que não estão disponíveis ao SUS, 
          por 100.000 habitantes, por localidade geográfica e ano.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Mede a disponibilidade de leitos hospitalares de UTI que não estão disponíveis para o SUS para a população 
          residente de determinada localidade geográfica. Logo, quanto maior a quantidade de leitos (por 100.000 habitantes), 
          maior o potencial de oferta de serviços de saúde e de acesso a esses serviços, no âmbito da saúde suplementar.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          ...
          leitos UTI não-SUS), conforme consta na documentação da RIPSA¹, identificando situações de desigualdade e 
          tendências que demandem ações e estudos específicos. Também é possível, segundo a RIPSA¹, que o indicador 
          subsidie processos de planejamento, gestão e avaliação de políticas públicas voltadas para a assistência 
          médico-hospitalar.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          estadual. Ainda segundo a Documentação Oficial do CNES², um leito complementar exibido como Leito não-SUS, atualmente, 
          pode ter dois significados: a) trata-se de leito que não é utilizado no âmbito do SUS (isto deve ocorrer somente 
          em hospitais privados); ou b) trata-se de leito utilizado no âmbito do SUS, mas que não foi habilitado pelo 
          Ministério da Saúde (isto pode ocorrer em hospitais públicos e privados). Sendo assim é possível que alguns 
          leitos SUS estejam sendo contabilizados como leitos não-SUS. Sobre a confiabilidade do número de leitos, 
          ...
          que atendem pacientes não-SUS no CNES. Portanto, não é possível ter certeza sobre o quanto da variação encontrada nos 
          dados pode ser atribuída a uma melhora ou piora do cadastro e quanto provêm de uma real mudança no número de leitos não-SUS.`}
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            ...
            unidade geográfica-ano, com informações referentes ao mês de dezembro, e dados de população municipal 
            obtidos do TabNet/DATASUS.
          </S.Li>
          <S.Li>
            Considerou-se somente os leitos de UTI — isto é, caso a variável “CODLEITO” fosse igual a:
            <S.Ul>
              <S.Li>61 - UTI Adulto</S.Li>
              <S.Li>62 - UTI Infanti</S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ² Wiki, Saúde. Página principal Cadastro Nacional de Estabelecimentos de Saúde. [Internet].
              [citado 14 de outubro de 2021]. Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ...
              estabelecimentos de saúde: Evidências sobre a confiabilidade dos dados. Ciência e Saúde Coletiva. 
              2018;23(1):229–40.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
