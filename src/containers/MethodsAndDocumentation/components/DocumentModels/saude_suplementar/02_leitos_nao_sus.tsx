...
export const LeitosNaoSus = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Leitos Não-SUS (por 100.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de leitos que não estão disponíveis ao SUS, por 100.000 habitantes, por localidade geográfica e ano.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Mede a disponibilidade de leitos hospitalares que não estão disponíveis para o SUS para a população residente 
          de determinada localidade geográfica. Logo, quanto maior a quantidade de leitos (por 100.000 habitantes), 
          maior o potencial de oferta hospitalar e de acesso a esses serviços, no âmbito da saúde suplementar.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          ...
          leitos hospitalares não-SUS), conforme consta na documentação da RIPSA¹, identificando situações de desigualdade 
          e tendências que demandem ações e estudos específicos. Também é possível, segundo a RIPSA¹, que o indicador 
          subside processos de planejamento, gestão e avaliação de políticas públicas voltadas para a assistência médico-hospitalar.
        </S.Paragraphy>
      </Section>

      <Section title={'Limitações'}>
        <S.Paragraphy>
          {`Leitos não-SUS resultam diretamente da subtração dos leitos existentes e leitos SUS realizada automaticamente 
          pelo CNES, segundo a Documentação Oficial². Portanto, o quantitativo nunca é informado pelo gestor municipal e 
          estadual. Ainda segundo a Documentação Oficial do CNES², um leito complementar exibido como Leito não-SUS, 
          atualmente, pode ter dois significados: a) trata-se de leito que não é utilizado no âmbito do SUS (isto deve 
          ocorrer somente em hospitais privados); ou b) trata-se de leito utilizado no âmbito do SUS, mas que não foi 
          habilitado pelo Ministério da Saúde (isto pode ocorrer em hospitais públicos e privados). Sendo assim, é possível 
          que alguns leitos SUS estejam sendo contabilizados como leitos não-SUS. Sobre a confiabilidade do número de leitos, 
          Rocha et al.³ documentaram, por meio de survey com 2.777 hospitais, que os dados do CNES apresentam uma boa 
          confiabilidade quanto ao status de funcionamento, o quantitativo de equipes e as coordenadas geográficas. Entretanto, 
          os dados referentes ao número de leitos cadastrados não apresentam boa confiabilidade — no caso do estudo supracitado, 
          o CNES continha o número correto de leitos de somente 44% dos hospitais visitados. Além disso, os serviços de saúde 
          devem atualizar seus dados no CNES a cada seis meses. Caso esse prazo não seja cumprido, os dados serão considerados 
          desativados, segundo a Portaria nº 118/2014⁴. Não foram encontradas informações acerca da cobertura de estabelecimentos 
          que atendem pacientes não-SUS no CNES. Portanto, não é possível ter certeza sobre o quanto da variação encontrada nos dados 
          pode ser atribuída a uma melhora ou piora do cadastro e quanto provêm de uma real mudança no número de leitos não-SUS.`}
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            Utilizou-se a variável dos microdados que contém a quantidade de leitos não-SUS (“QT_NSUS”), somada por 
            unidade geográfica, com informações referentes ao mês de dezembro, e dados de população municipal 
            obtidos do TabNet/DATASUS.
          </S.Li>
          <S.Li>
            Considerou-se para análise todos tipos de leitos, à exceção apenas dos leitos psiquiátricos (“CODLEITO” = 47), 
            para melhor representar a disponibilidade de recursos hospitalares.
          </S.Li>
          <S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ Brasil, Ministério da Saúde. Número de leitos hospitalares por habitante – CNES/MS – E.3 [Internet].
            ...
            <S.ReferenciaLink>
              ² Wiki, Saúde. Página principal Cadastro Nacional de Estabelecimentos de Saúde. [Internet].[citado 14 
              de outubro de 2021]. Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ⁴ Brasil, Ministério da Saúde. Portaria 118, 18 de fevereiro de 2014 [Internet]. [citado 14 de outubro 
            ...
            <S.ReferenciaLink>
              ⁵ CNES. Downloads da Documentação Serviços Redes Sociais Sobre o site. Tabelas de Domínio. 2021;10–1. 
              [Internet].[citado 14 de outubro de 2021]. Disponível em:{' '}
              <a
