...
export const EnfermeirosUnicamenteIdentificadosPorLocalidadePor1000Hab = () => {
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de enfermeiros unicamente identificados, por 1.000 habitantes, por localidade geográfica e ano.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          ...
          semelhante de cobertura. Além disso, possibilita o exame da distribuição de enfermeiros do ponto de vista 
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          constatar as limitações nos dados para uma parcela dos estabelecimentos analisados. Medeiros e Calvo⁵, ao 
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            ...
            apenas uma vez utilizando essa variável. Dessa forma, os enfermeiros foram unicamente identificados dentro 
            de uma localidade e agregados para a região-ano em questão.
          </S.Li>
          <S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ⁴ Costa LR, Costa JLR, Oishi J, Driusso P. Distribuição de fisioterapeutas entre estabelecimentos 
              públicos e privados nos diferentes níveis de complexidade de atenção à saúde. 
              Brazilian J Phys Ther. 2012;16(5):422–30.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
              ⁵ Almeida G De, Medeiros R. Serviços públicos de média complexidade ambulatorial em fisioterapia 
              vinculados ao sistema único de saúde em Santa Catarina. Rev Saúde Pública Santa Catarina. 2014;7(2):7–16.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
