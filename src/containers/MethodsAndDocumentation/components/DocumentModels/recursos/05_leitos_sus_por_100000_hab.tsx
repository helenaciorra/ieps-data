...
export const LeitosSusPor100000Hab = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Leitos SUS (por 100.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de leitos do SUS, por 100.000 habitantes, por localidade geográfica e ano.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Mede a disponibilidade de leitos hospitalares conveniados ou contratados pelo SUS para a população residente de 
          determinada localidade geográfica. Logo, quanto maior quantidade de leitos (por 100.000 habitantes), maior o 
          potencial de oferta hospitalar de serviços de saúde e de acesso a esses serviços. Entretanto, é importante 
          salientar que a quantidade de leitos SUS ofertada não deve ser analisada ao nível municipal, e sim em níveis 
          mais agregados de região e macrorregião de saúde. Sendo assim, é possível que existam municípios sem leitos 
          SUS inseridos em regiões de saúde que provêm essa oferta.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          ...
          caso, leitos hospitalares pelo SUS), conforme consta na documentação da RIPSA¹, identificando situações de 
          desigualdade e tendências que demandem ações e estudos específicos. Também é possível, segundo a RIPSA¹, que o 
          indicador subsidie processos de planejamento, gestão e avaliação de políticas públicas voltadas para a 
          assistência médico-hospitalar de responsabilidade do SUS. Ressalta-se que não é necessário haver leitos em 
          todos os municípios, de forma que o indicador deve ser analisado ao nível de região e macrorregião de saúde.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            Considerou-se para análise todos os tipos de leitos, à exceção apenas dos leitos psiquiátricos (“CODLEITO” = 47)⁵, 
