...
export const EnfermeirosPadronizadosPorCargaHorariaPor1000Hab = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Enfermeiros (Padronizados por Carga Horária, por 1.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de enfermeiros padronizados pela carga horária de 40h semanais, por 1.000 habitantes, por localidade geográfica e ano.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Mede a disponibilidade de recursos humanos de saúde — enfermeiros, nesse caso — para a população residente de 
          determinada localidade geográfica. Logo, quanto maior a quantidade de enfermeiros (por 1.000 habitantes), 
          maior o potencial de oferta de serviços de saúde e de acesso a esses serviços.
        </S.Paragraphy>
      </Section>

      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite a verificação, por território, da disponibilidade de enfermeiros, com a indicação de 
          áreas com maior e menor cobertura desses profissionais, conforme especificado pelo IDSUS¹. Além disso, 
          possibilita o exame da distribuição de enfermeiros do ponto de vista geográfico e temporal, com a indicação de 
          eventuais desigualdades e tendências passíveis de estudo e aprofundamento. Também fornece dados para a 
          elaboração e avaliação de políticas públicas na área de saúde. Por fim, a padronização por carga horária tem o 
          objetivo de aproximar a real disponibilidade dos profissionais, tendo em vista que a carga horária total pode 
          ser distribuída entre mais de um município de forma desigual - como, por exemplo, um enfermeiro que gasta 
          20% de sua carga em um município e 80% em outro.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          constatar limitações nos dados para uma parcela dos estabelecimentos analisados. Medeiros e Calvo⁵, ao 
          descreverem a distribuição dos serviços públicos de fisioterapia cadastrados na média complexidade 
          ambulatorial em Santa Catarina, observaram que o CNES estava desatualizado e sem preenchimento, 
          principalmente em relação à quantidade de profissionais e tipo de equipamentos.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            A carga horária total de cada ocupação de enfermeiros é dada pela soma das variáveis 
            “HORAOUTR”, “HORAHOSP” e “HORA_AMB”.
          </S.Li>
          <S.Li>
            Foram consideradas as classificações brasileiras de ocupação (CBO) de enfermeiros descritas pelo DATASUS⁶.
          </S.Li>
          <S.Li>
            Para cada ano, foram utilizadas as informações de ocupações do CNES do mês de dezembro.
          </S.Li>
          <S.Li>
            Para obter o número de enfermeiros padronizados por carga horária, foi somado o número de horas totais 
            trabalhadas de todas as ocupações desses profissionais em determinada localidade/ano e dividido por 40 horas.
          </S.Li>
          <S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ² Brasil, Ministério da Saúde Portaria 118, 18 de fevereiro de 2014. [Internet]. [citado 13 de outubro de 2021]. Disponível em:{' '}
              <a
