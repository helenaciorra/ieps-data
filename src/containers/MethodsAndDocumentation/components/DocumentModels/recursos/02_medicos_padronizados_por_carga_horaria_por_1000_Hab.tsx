...
export const MedicosPadronizadosPorCargaHorariaPor1000Hab = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Médicos (Padronizados por Carga Horária, por 1.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Número de médicos padronizados pela carga horária de 40h semanais, por 1.000 habitantes, por localidade geográfica e ano.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Interpretação'}>
        <S.Paragraphy>
          ...
          determinada localidade geográfica. Logo, quanto maior a quantidade de médicos (por 1.000 habitantes), 
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite a verificação, por território, da disponibilidade de médicos, com a indicação de áreas 
          com maior e menor cobertura desses profissionais, conforme especificado pelo IDSUS¹. Além disso, possibilita o 
          exame da distribuição de médicos do ponto de vista geográfico e temporal, com a indicação de eventuais 
          desigualdades e tendências passíveis de estudo e aprofundamento. Também fornece dados para a elaboração e 
          avaliação de políticas públicas na área de saúde. Por fim, a padronização por carga horária tem o objetivo de 
          aproximar a real disponibilidade dos profissionais, tendo em vista que a carga horária total pode ser distribuída 
          entre mais de um município de forma desigual - como, por exemplo, um médico que gasta 20% de sua carga em 
          um município e 80% em outro.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          descreverem a distribuição dos serviços públicos de fisioterapia cadastrados na média complexidade ambulatorial 
          em Santa Catarina, observaram que o CNES estava desatualizado e sem preenchimento, principalmente em relação 
          à quantidade de profissionais e tipo de equipamentos.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          ...
          <S.Li>
            A carga horária total de cada ocupação de médicos é dada pela soma das variáveis “HORAOUTR”, “HORAHOSP” e “HORA_AMB”.
          </S.Li>
          <S.Li>
          ...
          <S.Li>
            Para obter o número de médicos padronizados por carga horária, foi somado o número de horas totais trabalhadas 
            de todas as ocupações desses profissionais em determinada localidade/ano e dividido por 40 horas.
          </S.Li>
          <S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ³ Santos FAS, Gouveia GC, Martelli PJL, Vasconcelos EMR. Acupuntura no sistema único de saúde e a 
              inserção de profissionais não-médicos. Rev Bras Fisioter. 2009;13(4):330–4.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
