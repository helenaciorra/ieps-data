...
export const MortalidadeBrutaPorCondicoesSensiveisAtencaoPrimariaPor100000Hab = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Mortalidade Bruta por Condições Sensíveis à Atenção Primária (por 100.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Expressa a intensidade com a qual a mortalidade por condições sensíveis à atenção primária atua 
          sobre uma determinada população. Óbitos por Condições Sensíveis à Atenção Primária representam 
          mortes que poderiam ser evitadas com ações de atenção primária. Por se tratar de uma taxa bruta, 
      ...
      <Section title={'Interpretação'}>
        <S.Paragraphy>
          ...
          evitadas com ações de atenção primária. Por se tratar de uma taxa bruta, sem ajuste, a sua utilidade para 
          comparações com outras unidades geográficas e temporais é limitada, em decorrência de diferenças na 
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais da mortalidade por condições 
          sensíveis à atenção primária. Além disso, possibilita o cálculo do crescimento vegetativo ou natural da população, 
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          informação de causas de morte, com CIDs não informadas ou mal definidas ou inespecíficas. Além disso, 
          trata-se de taxas brutas, sem padronização etária nem de sexo. Como a taxa é fortemente influenciada pela 
          estrutura etária da população, a análise comparada entre populações de composição distinta exige padronização 
          das estruturas etárias. Conforme especificado pelo TabNet/DATASUS¹, somente as taxas padronizadas devem ser 
          utilizadas para análises comparativas.
        </S.Paragraphy>
      </Section>
      <Section title={'Qualidade dos dados do SIM'}>
        <S.Paragraphy>
          Estimativas referentes ao número de óbitos estão sujeitas a limitações na cobertura do 
          Sistema de Informações sobre Mortalidade (SIM). Estas limitações, segundo IBGE³, 
          na maioria dos casos estão relacionadas a:
        </S.Paragraphy>
        <S.Paragraphy>
        ...
        <S.Paragraphy>
          ...
          sepultamentos sem a exigência da Declaração de Óbito (DO), sendo associada à pobreza e prevalente nos 
          municípios rurais e de pequeno porte populacional. A esse respeito, o IBGE realizou um cálculo para estimar 
          a cobertura do SIM no período de 2000-2011, dividindo o número de óbitos notificados ao SIM pelo número 
          estimado pelo IBGE, na população residente em determinado espaço geográfico, no ano considerado. Os resultados 
          indicam que, a despeito de uma melhora progressiva na cobertura durante o período analisado, as regiões Norte 
          e Nordeste ainda possuem uma cobertura mais baixa que as outras regiões, ambas abaixo de 90%⁴. Para o ano 
          de 2015, estimativas realizadas por Trindade, Costa e Oliveira³ apontam que o indicador de cobertura do SIM 
          para o Brasil foi de 97,2% para o Brasil (mínimo de 91,2% no Amapá).
        </S.Paragraphy>
        <S.Paragraphy>
          Além disso, existe também um problema relativo à qualidade dos dados do SIM referentes a óbitos por causas 
          mal definidas ou inespecíficas. Tratam-se de casos em que é difícil identificar a causa básica da morte na 
          ...
          por causas mal definidas/número total de óbitos de residentes) tanto em nível nacional como estadual e 
          municipal, separando possíveis causas em 3 listas. Em 2019, utilizando a classificação de mal-definição da 
          Lista 3 (códigos R00-R99)⁶, 6,07% dos óbitos registrados nacionalmente corresponderam a causas mal definidas. 
        ...
        <S.Paragraphy>
          ...
          de causas mal definidas, que podem ser consideradas um tipo dentro da lista de causas pouco úteis. 
          Sistemas de registro de mortalidade com alta proporção deste tipo de causa têm sua qualidade comprometida. 
          Os codificadores de causas de mortalidade referem-se a estes óbitos como aqueles cuja causa básica faz 
          parte de uma lista classificada como “códigos lixo” (garbage codes)⁷. O TabNet/DATASUS também realiza 
          estimativas sobre a proporção de óbitos nessa categoria, realizando uma síntese que divide a categoria em Tipos. 
        </S.Paragraphy>
      </Section>
