...
import formulaImage2 from './img/06_02.png';
...
export const MortalidadeAjustadaPor100000Hab = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Mortalidade Ajustada (por 100.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Expressa a intensidade com a qual a mortalidade atua sobre uma determinada população. O ajuste etário 
          limpa a taxa bruta da influência da composição etária do local, permitindo que sejam feitas comparações 
          entre unidades geográficas e intertemporais. Essas comparações não devem ser realizadas com taxas brutas.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Expressa a intensidade com a qual a mortalidade atua sobre uma determinada população. O ajuste etário limpa 
          a taxa bruta da influência da composição etária do local, permitindo que sejam feitas comparações entre 
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais da mortalidade total. Por se tratar de uma 
          taxa ajustada, permite análise comparada temporal e entre populações.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Qualidade dos dados do SIM'}>
        ...
        <S.Paragraphy>
          ...
          ocorridos, para os quais DOs e DNs foram emitidas nas unidades de saúde, é registrada em Cartório sem, contudo, 
          serem consolidadas nos Sistemas de Informação do Ministério.” 
        </S.Paragraphy>
        <S.Paragraphy>
          ...
          rurais e de pequeno porte populacional. A esse respeito, o IBGE realizou um cálculo para estimar a cobertura do 
          SIM no período de 2000-2011, dividindo o número de óbitos notificados ao SIM pelo número estimado pelo IBGE, 
          na população residente em determinado espaço geográfico, no ano considerado. Os resultados indicam que, a despeito 
          de uma melhora progressiva na cobertura durante o período analisado, as regiões Norte e Nordeste ainda possuem uma 
          cobertura mais baixa que as outras regiões, ambas abaixo de 90%⁴. Para o ano de 2015, estimativas realizadas 
        ...
        <S.Paragraphy>
          ...
          de Óbito. Essas dificuldades estão em geral associadas ao uso de expressões ou termos imprecisos⁵. O TabNet/DATASUS 
          estima a proporção da mortalidade por causas mal definidas (número de óbitos de residentes por causas mal 
          definidas/número total de óbitos de residentes) tanto em nível nacional como estadual e municipal, separando 
          possíveis causas em 3 listas. Em 2019, utilizando a classificação de mal-definição da Lista 3 (códigos R00-R99)⁶, 
          6,07% dos óbitos registrados nacionalmente corresponderam a causas mal definidas. No nível do estado 
          (considerando a UF de residência), o Espírito Santo apresentou a menor proporção (0,85%) e a Bahia, o maior 
          (13,34%). A esse respeito, existem métodos de redistribuição de causas mal definidas baseados na investigação dos óbitos⁷. 
        </S.Paragraphy>
        <S.Paragraphy>
          Existem ainda as chamadas “causas pouco úteis”, que se referem a ocorrências onde as causas básicas de óbito 
          têm diagnósticos indefinidos ou incompletos, que não indicam a causa específica de morte, a exemplo de septicemia, 
          paralisia cerebral, insuficiência renal, entre outros. Trata-se de uma categoria mais geral que a de causas mal 
          definidas, que podem ser consideradas um tipo dentro da lista de causas pouco úteis. Sistemas de registro de 
          mortalidade com alta proporção deste tipo de causa têm sua qualidade comprometida. Os codificadores de causas 
          de mortalidade referem-se a estes óbitos como aqueles cuja causa básica faz parte de uma lista classificada 
          como “códigos lixo” (garbage codes)⁷. O TabNet/DATASUS também realiza estimativas sobre a proporção de óbitos 
          nessa categoria, realizando uma síntese que divide a categoria em Tipos.. 
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            Utilizou-se as informações individuais de óbitos disponibilizadas nos microdados, que foram somadas ao 
            nível de município-ano, e dados de população municipal obtidos do TabNet/DATASUS.
          </S.Li>
          <S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ³ de Oliveira, Antônio Tadeu Ribeiro. Sistemas de estatísticas vitais no Brasil: avanços, perspectivas e desafios. IBGE, 
              Coordenação de População e Indicadores Sociais. 2018; ISBN:978-85-240-4459-5.
            </S.ReferenciaLink>
            <S.ReferenciaLink>
            ...
            <S.ReferenciaLink>
              ...
              AGE STANDARDIZATION OF RATES: A NEW WHO STANDARD Christopher JL Murray Rafael Lozano Mie Inoue GPE 
              Discussion Paper Series: No . 31 EIP/GPE/EBD World Health Organization 2001 [Internet].
              [citado 11 de outubro de 2021]. Disponível em:{' '}
              <a
