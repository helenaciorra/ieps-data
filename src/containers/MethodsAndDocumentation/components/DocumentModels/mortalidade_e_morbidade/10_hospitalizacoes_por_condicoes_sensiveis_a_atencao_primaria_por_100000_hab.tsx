...
import formulaImage from './img/10.png';
...
export const HospitalizacoesPorCondicoesSensiveisAtencaoPrimariaPor100000Hab = () => {
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Taxa de hospitalizações por Condições Sensíveis à Atenção Primária (CSAP) por 100.000 habitantes, 
          realizadas no âmbito do Sistema Único de Saúde (SUS), considerando o local de residência..
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Reflete o acesso de residentes de um determinado local a hospitalizações pelo SUS em um ano. A lista de 
          hospitalizações por Condições Sensíveis à Atenção Primária serve como instrumento de avaliação da atenção 
          primária e/ou da utilização hospitalar no SUS, conforme Portaria nº 221/2018 do Ministério da Saúde¹. 
          A classificação de condições sensíveis à atenção  primária é feita com base na definição do Ministério 
          da Saúde e refere-se aos casos de doenças que poderiam ser evitados com ações de atenção primária.
        </S.Paragraphy>
      </Section>

      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais na distribuição de internações hospitalares 
          por condições sensíveis à atenção primária pelo SUS. Além disso, permite acompanhar o desempenho da 
          atenção primária no local.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          ...
          privados conveniados), não sendo contabilizadas hospitalizações realizadas na saúde suplementar (cooperativa 
          médica, medicina de grupo, auto-gestão e seguradora), assistência prestada a servidores públicos civis e 
          militares, nem as referentes a recursos próprios da unidade de internação e a serviços prestados mediante 
          desembolso direto². Pode, ainda, não incluir todas as internações efetivamente realizadas pelo SUS. Há a 
          possibilidade de subnotificação do número de internações, além de problemas na identificação de reinternações 
          e transferências do mesmo paciente ²-³. Pode haver também problemas na informação de causas de internação, 
          com CIDs não informadas ou mal definidas ou inespecíficas. Ademais, pacientes podem informar como município 
          de residência aquele no qual foram atendidos, por temer não receber o atendimento no local escolhido⁴.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            Utilizou-se as informações individuais de hospitalizações disponibilizadas nos microdados, que foram somadas 
            ao nível de município-ano, considerando o município de residência do paciente e as internações por condições 
            sensíveis à atenção primária (CSAP), e dados de população municipal disponibilizados pelo TabNet/DATASUS.
          </S.Li>
          <S.Li>
            ...
            Na internação original esta variável aparece como sendo igual à 1, portanto filtramos apenas as observações 
            com “IDENT” = 1. Caso ocorra uma re-internação após três dias de alta, uma nova sequência de AIH é gerada e 
            contabiliza-se como uma nova internação³.
          </S.Li>
          <S.Li>
            Utilizou-se a classificação de Condições Sensíveis à Atenção Primária utilizada conforme proposta 
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ Brasil. Ministério da Saúde. Portaria 221, 17 de abril de 2008 [Internet]. [citado 08 de outubro de 2021]. 
              Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ...
              [citado 08 de outubro de 2021]. Disponível em:{' '}
              <a
