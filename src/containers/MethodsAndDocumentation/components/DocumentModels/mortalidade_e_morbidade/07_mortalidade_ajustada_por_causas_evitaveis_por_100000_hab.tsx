...
import formulaImage from './img/07.png';
import formulaImage2 from './img/07_02.png';
...
export const MortalidadeAjustadaPorCausasEvitaveisPor100000Hab = () => {
  return (
    <div>
      <div style={{ maxWidth: '600px' }}>
        <S.PageTitle>
          Mortalidade Ajustada por Causas Evitáveis (por 100.000 Hab.)
        </S.PageTitle>
      </div>

      <Section title={'Indicador'}>
        <S.Paragraphy>
          Taxa de óbitos por causas evitáveis por 100.000 habitantes, considerando o local de residência, ajustado por idade.
        </S.Paragraphy>
      </Section>

      <Section title={'Interpretação'}>
        <S.Paragraphy>
          Expressa a intensidade com a qual a mortalidade por causas evitáveis atua sobre uma determinada população. 
          Causas evitáveis representam mortes que poderiam ser evitadas por ações de serviços de saúde. O ajuste etário 
          limpa a taxa bruta da influência da composição etária do local, permitindo que sejam feitas comparações entre 
          unidades geográficas e intertemporais. Essas comparações não devem ser realizadas com taxas brutas.
        </S.Paragraphy>
      </Section>

      <Section title={'Usos'}>
        <S.Paragraphy>
          Este indicador permite analisar variações geográficas e temporais da mortalidade por causas evitáveis. Por se 
          tratar de uma taxa ajustada, permite análise comparada temporal e  entre populações.
        </S.Paragraphy>
      </Section>

      <Section title={'Limitações'}>
        <S.Paragraphy>
          O uso de dados de mortalidade derivados de sistemas de registro contínuo está condicionado a correções, devido 
          à subenumeração de óbitos, frequente em áreas menos desenvolvidas². É possível também que haja problemas na 
          informação de causas de morte, com CIDs não informadas ou mal definidas ou inespecíficas.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Qualidade dos dados do SIM'}>
        ...
        <S.Paragraphy>
          De forma semelhante, 
          segundo Almeida⁴, a subenumeração de óbitos diz respeito, principalmente, à ocorrência de sepultamentos sem a 
          exigência da Declaração de Óbito (DO), sendo associada à pobreza e prevalente nos municípios rurais e de 
          pequeno porte populacional. A esse respeito, o IBGE realizou um cálculo para estimar a cobertura do SIM no 
          período de 2000-2011, dividindo o número de óbitos notificados ao SIM pelo número estimado pelo IBGE, na 
          população residente em determinado espaço geográfico, no ano considerado. Os resultados indicam que, a 
          despeito de uma melhora progressiva na cobertura durante o período analisado, as regiões Norte e Nordeste 
          ainda possuem uma cobertura mais baixa que as outras regiões, ambas abaixo de 90%⁴. Para o ano de 2015, 
          estimativas realizadas por Trindade, Costa e Oliveira³ apontam que o indicador de cobertura do SIM para o 
          Brasil foi de 97,2% para o Brasil (mínimo de 91,2% no Amapá).
        </S.Paragraphy>
        <S.Paragraphy>
          Além disso, existe também um problema relativo à qualidade dos dados do SIM referentes a óbitos por causas mal 
          definidas ou inespecíficas. Tratam-se de casos em que é difícil identificar a causa básica da morte na 
          Declaração de Óbito. Essas dificuldades estão em geral associadas ao uso de expressões ou termos imprecisos⁵. 
          ...
          (códigos R00-R99)⁶, 6,07% dos óbitos registrados nacionalmente corresponderam a causas mal definidas. No nível 
          do estado (considerando a UF de residência), o Espírito Santo apresentou a menor proporção (0,85%) e a Bahia, 
          o maior (13,34%). A esse respeito, existem métodos de redistribuição de causas mal definidas baseados na 
        ...
        <S.Paragraphy>
          ...
          septicemia, paralisia cerebral, insuficiência renal, entre outros. Trata-se de uma categoria mais geral que a
          de causas mal definidas, que podem ser consideradas um tipo dentro da lista de causas pouco úteis. Sistemas de
          registro de mortalidade com alta proporção deste tipo de causa têm sua qualidade comprometida. Os codificadores
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            ...
            individuais de óbitos disponibilizadas nos microdados foram somadas ao nível de município-ano, e dados 
            de população municipal foram obtidos do TabNet/DATASUS.
          </S.Li>
          <S.Li>
            Foi realizado o cálculo da taxa por 100.00 habitantes.
          </S.Li>
          <S.Li>
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ Brasil, Ministério da Saúde. Taxa Bruta de Mortalidade [Internet].[citado 07 de outubro de 2021]. 
              Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ...
              desafios. IBGE, Coordenação de População e Indicadores Sociais. 2018; [61]pg.SBN:978-85-240-4459-5.
            </S.ReferenciaLink>
            <S.ReferenciaLink>
            ...
            <S.ReferenciaLink>
              ⁵ Brasil, Ministério da Saúde. Mortalidade proporcional por causas mal definidas. [Internet].
            ...
            <S.ReferenciaLink>
              ⁷ França EB. Garbage codes assigned as cause-of-death in health statistics. Rev 
              Bras Epidemiol. 2019;22(Suppl 3).{' '}
              <a
            ...
            <S.ReferenciaLink>
              ...
              Br Med J. 2003;327(7424):1129–32.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
              ⁹ Nolte E, McKee M. Variations in amenable mortality-Trends in 16 high-income nations. Health Policy 
              (New York). 2011;103(1):47–52.{' '}
            </S.ReferenciaLink>
            <S.ReferenciaLink>
              ¹⁰ IBGE. Censo 2010.[Internet].[citado 11 de outubro de 2021]. 
              Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ¹¹ Ahmad O Ben, Ahmad OB, Boschi-pinto C, Lopez AD. Age Standardization of Rates: A New WHO Standard 
              AGE STANDARDIZATION OF RATES: A NEW WHO STANDARD Christopher JL Murray Rafael Lozano Mie Inoue GPE Discussion 
