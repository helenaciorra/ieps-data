...
export const IndiceDesenvolvimentoHumanoMunicipal = () => {
  return (
    <div>
      ...
      <Section title={'Interpretação'}>
        <S.Paragraphy>
          ...
          calcula-se o IDHM, formulado considerando três dimensões: longevidade, educação e renda. O indicador oferece 
          um complemento ao indicador do Produto Interno Bruto (PIB) per capita, na medida em que não está restrito à 
          dimensão econômica do desenvolvimento¹.  O IDHM é um número que varia entre 0 a 1. Quanto mais próximo de 1, 
          maior o desenvolvimento humano da localidade.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          O IDHM, assim como o IDH, é uma importante ferramenta de avaliação analítica para conhecer o nível de bem-estar 
          de uma localidade e realizar comparações. Ele permite ainda acompanhar o progresso de iniciativas de redução 
          da pobreza e, de forma geral, avanços nas condições de vida da população².
        </S.Paragraphy>
      </Section>

      <Section title={'Limitações'}>
        <S.Paragraphy>
          As variáveis utilizadas para calcular os componentes do IDHM são retiradas do Censo, 
          portanto só é possível calcular o IDHM em anos censitários.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            Para os níveis municipal, estadual e federal, utilizou-se os valores já calculados do IDHM fornecidos 
            pelo Atlas Brasil².
          </S.Li>
          <S.Li>
            Para os níveis da Região e Macrorregião de Saúde, seguiu-se metodologia de agregação proposta e adotada 
            pelo PROADESS³. O processo de cálculo destes sub-índices é similar ao exemplificado na Tabela 1 de Rabelais 
            et al. (2015)³. A metodologia consiste no cálculo de cada dimensão do IDHM no nível da Região/Macrorregião 
            de Saúde através de agregações dos indicadores municipais ponderados pelas respectivas razões entre o total 
            de residentes dos municípios e o total de residentes da Região ou Macrorregião de Saúde nas faixas etárias 
            específicas³.
          </S.Li>
          <S.Li>
            A partir dos valores das três dimensões do IDHM, foi realizado o cálculo conforme a seguinte fórmula padrão de agregação proposta pelo PNUD²:
      ...
      <Section title="REFERÊNCIAS">
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            <S.ReferenciaLink>
              ¹ PNUD, Índice de Desenvolvimento Humano. O que é o IDH. 1998. [Internet] [citado 23 de novembro de 2021]. 
              Disponível em:{' '}
              <a
            ...
            <S.ReferenciaLink>
              ² Atlas do Desenvolvimento Humano. Índice de Desenvolvimento Humano Municipal - IDHM. Metodologia. 
              [Internet] [citado 23 de novembro de 2021]. Disponível em:{' '}
              <a
