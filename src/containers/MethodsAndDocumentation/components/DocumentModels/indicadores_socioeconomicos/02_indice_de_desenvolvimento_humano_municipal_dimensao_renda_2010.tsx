...
export const IndiceDesenvolvimentoHumanoMunicipalDimensaoRenda = () => {
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Índice de Desenvolvimento Humano Municipal (IDHM), especificamente a dimensão “Renda”.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Interpretação'}>
        <S.Paragraphy>
          ...
          calcula-se o IDHM, formulado considerando as dimensões: longevidade, educação e renda. A dimensão “Renda” 
          considera o indicador de renda municipal per capita, definida como a renda média de cada residente 
          do município¹.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Limitações'}>
        <S.Paragraphy>
          Este indicador não considera a desigualdade de renda entre residentes de uma mesma unidade geográfica¹, de 
          modo que uma localidade com elevada renda per capita pode mascarar uma realidade de grande desigualdade local.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            ...
            “Renda”, fornecidos pelo Atlas Brasil¹.
          </S.Li>
          <S.Li>
            ...
            et al. (2015)². A metodologia consiste na agregação do indicador municipal ponderado pelas respectivas 
            razões entre o total de residentes dos municípios e o total de residentes da Região ou Macrorregião de Saúde²
          </S.Li>
          <S.Li>
            Foi realizado o cálculo, com base em dados do Censo Demográfico, conforme a seguinte fórmula:
            ...
            <S.Ul>
              ...
              <S.Li>
                Valor máximo ref = R$ 4.033,00. Corresponde ao valor da menor renda per capita entre os 10% mais ricos 
                residentes na UF com maior renda média do país no período analisado¹;
              </S.Li>
              <S.Li>
                Valor mínimo ref = R$ 8,00. Corresponde a aproximadamente US$ 100 PPC, 
                limite adotado para o cálculo do IDH global¹.
              </S.Li>
            </S.Ul>
          </S.Li>
        </S.Ol>
        ...
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <S.ReferenciaLink>
              ...
              desenvolvimento humano: Uma proposta de tipologia de Regiões de Saúde no Brasil. Cad Saude Publica. 2015;31(6):1163–74.{' '}
            </S.ReferenciaLink>
          </div>
        </div>
      </Section>
