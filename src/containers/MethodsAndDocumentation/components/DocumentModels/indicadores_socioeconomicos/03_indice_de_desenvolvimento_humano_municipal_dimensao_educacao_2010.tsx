...
export const IndiceDesenvolvimentoHumanoMunicipalDimensaoEducacao = () => {
  return (
    <div>
      ...
      <Section title={'Indicador'}>
        <S.Paragraphy>
          Índice de Desenvolvimento Humano Municipal (IDHM), especificamente a dimensão “Educação”.
        </S.Paragraphy>
      </Section>
      ...
      <Section title={'Interpretação'}>
        <S.Paragraphy>
          ...
          calcula-se o IDHM, formulado considerando as dimensões: longevidade, educação e renda. A dimensão “Educação” 
          do IDHM é uma composição de indicadores de escolaridade da população adulta e de fluxo escolar da população jovem¹.
        </S.Paragraphy>
        <div className="alert">
      ...
      <Section title={'Usos'}>
        <S.Paragraphy>
          A escolaridade da população adulta reflete o funcionamento do sistema educacional em períodos passados, 
          considerando-se que a população adulta deveria ter completado, ao menos, o ensino fundamental. Já o fluxo 
          escolar da população jovem acompanha a população em idade escolar em quatro momentos de sua formação¹.
        </S.Paragraphy>
      </Section>

      <Section title={'Limitações'}>
        <S.Paragraphy>
          Ao acompanhar os estudantes em apenas quatro momentos de sua formação, o indicador referente à população jovem 
          não inclui toda a população em idade escolar que frequenta a escola. Já o indicador referente à escolaridade 
          da população adulta desconsidera aqueles que tiveram uma passagem pelo ensino fundamental, mas não completaram 
          o ciclo. Além disso, considera como suficiente o ensino fundamental completo¹.
        </S.Paragraphy>
      </Section>
      ...
      <Section title="Fórmula de Cálculo">
        <S.Ol>
          <S.Li>
            Para os níveis municipal, estadual e federal, utilizou-se os valores já calculados do IDHM, dimensão “Educação”, fornecidos pelo Atlas Brasil¹.
          </S.Li>
          <S.Li>
            Para os níveis da Região e Macrorregião de Saúde, seguiu-se metodologia de agregação proposta e adotada pelo PROADESS². O processo de cálculo 
            destes sub-índices é similar ao exemplificado na Tabela 1 de Rabelais et al. (2015)². A metodologia consiste na agregação do indicador municipal 
            ponderado pelas respectivas razões entre o total de residentes dos municípios e o total de residentes da Região ou Macrorregião de Saúde nas 
            faixas etárias específicas².
          </S.Li>
          <S.Li>
            Os componentes foram agregados da seguinte maneira:
            <S.Ul>
              <S.Li>
                Escolaridade da população adulta (peso 1) - percentual da população com 18 anos ou mais que possui 
                ensino fundamental completo¹;
              </S.Li>
              <S.Li>
                Fluxo escolar da população jovem (peso 2) - média aritmética de quatro percentuais de frequência escolar 
                calculados em quatro momentos distintos da educação: (1) o percentual de crianças de 5 a 6 anos 
                frequentando a escola; (2) o percentual de jovens de 11 a 13 anos frequentando os anos finais do ensino 
                fundamental regular; (3) o percentual de jovens de 15 a 17 anos com ensino fundamental completo; e (4) 
