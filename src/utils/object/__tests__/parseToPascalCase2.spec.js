...
const CAMEL_MOCK = [
  {
    ...
    method: {
      mashTemp: [{ temp: { value: 64, unit: 'celsius' }, duration: 75 }],
      fermentation: { temp: { value: 19, unit: 'celsius' } },
      twist: null,
    },
    ingredients: {
  ...
  },
  {
    ...
    boilVolume: { value: 25, unit: 'litres' },
    method: {
      mashTemp: [{ temp: { value: 69, unit: 'celsius' }, duration: null }],
      fermentation: { temp: { value: 18, unit: 'celsius' } },
      twist: null,
    },
    ingredients: {
  ...
  },
  {
    ...
    boilVolume: { value: 25, unit: 'litres' },
    method: {
      mashTemp: [{ temp: { value: 65, unit: 'celsius' }, duration: null }],
      fermentation: { temp: { value: 9, unit: 'celsius' } },
      twist: null,
    },
    ingredients: {
  ...
  },
  {
    ...
    boilVolume: { value: 25, unit: 'litres' },
    method: {
      mashTemp: [{ temp: { value: 66, unit: 'celsius' }, duration: 70 }],
      fermentation: { temp: { value: 10, unit: 'celsius' } },
      twist: null,
    },
    ingredients: {
  ...
  },
  {
    ...
    srm: 7.5,
    ph: 4.4,
    attenuationLevel: 88.9,
    volume: { value: 20, unit: 'litres' },
    boilVolume: { value: 25, unit: 'litres' },
    method: {
      mashTemp: [{ temp: { value: 65, unit: 'celsius' }, duration: 75 }],
      fermentation: { temp: { value: 22, unit: 'celsius' } },
      twist: 'Honey: 62.5g at End (WP), Coriander Seeds: 8.5g at 45mins',
    },
    ingredients: {
  ...
  },
  {
    ...
    boilVolume: { value: 25, unit: 'litres' },
    method: {
      mashTemp: [{ temp: { value: 69, unit: 'celsius' }, duration: 105 }],
      fermentation: { temp: { value: 21, unit: 'celsius' } },
      twist:
        'Aged in whisky barrels with raspberries, tayberries and blackberries',
    },
  ...
  },
  {
    ...
    boilVolume: { value: 25, unit: 'litres' },
    method: {
      mashTemp: [{ temp: { value: 65, unit: 'celsius' }, duration: 105 }],
      fermentation: { temp: { value: 11, unit: 'celsius' } },
      twist:
        'Scottish Heather Honey: 62.5g at middle, Add honey during the boil. After fermentation, age in a Scottish whisky cask',
    },
